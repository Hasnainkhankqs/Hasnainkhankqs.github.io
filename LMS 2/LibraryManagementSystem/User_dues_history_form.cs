...
{
    public partial class User_dues_history_form : Form
    {
        private string ConnectionString = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
        private SqlConnection conn = null;
        private SqlCommand cmd = null;
        public User_dues_history_form()
        {
            InitializeComponent();
        }

        private void User_dues_history_form_Load(object sender, EventArgs e)
        {
            Load_basic_info();
        ...
        public void Load_basic_info()
        {
            ...
            using (conn = new SqlConnection(ConnectionString))
            {
                try
                {
                    ...
                    profile.OverDues(user_id, dues_grid_view);
                }
                catch (Exception ex)
                {
